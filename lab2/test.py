...
class TestTiny(unittest.TestCase):
    ...
    def test_Bacon_number_0(self):
        self.assertEqual(lab.get_actors_with_bacon_number(self.data, 0), {4724})
    def test_Bacon_number_1(self):
        self.assertEqual(lab.get_actors_with_bacon_number(self.data, 1), {1532, 2876})
    def test_Bacon_number_2(self):
        self.assertEqual(lab.get_actors_with_bacon_number(self.data, 2), {1640})
    
    def test_Bacon_path(self):
        self.assertEqual(lab.get_bacon_path(self.data,46866), [4724, 2876, 1640, 46866])
        
    def test_path(self):
        self.assertEqual(lab.get_path(self.data,1532,2876), [1532, 4724,2876])
